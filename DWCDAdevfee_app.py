...
st.set_page_config(page_title="Divine Wisdom CDA Income Tracker(devfee)", page_icon="💰", layout="wide")
...
SPREADSHEET_ID = "1jQlLFJeimhaKhThr0v6fgvJNdHJkYeonO7zAxI5EfL8"
GID = 494362929
...
st.title("💰 Divine Wisdom CDA Income Tracker(devfee)")
