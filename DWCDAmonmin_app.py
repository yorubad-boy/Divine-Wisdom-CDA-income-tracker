...
st.set_page_config(page_title="Divine Wisdom CDA Income Tracker(monmin)", page_icon="💰", layout="wide")
...
CSV_URL = "https://docs.google.com/spreadsheets/d/1b3-M1xPw1AChLFFOQZ-0fnNlXie5AwuwLFUauvWrOhw/export?format=csv&gid=2080911856"
...
st.title("💰 Divine Wisdom CDA Income Tracker(monmin)")
